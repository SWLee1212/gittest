...
def get_not_duplicated_three_digit_number():
    ...
    while is_validated_number(str(result)) is False :
        result = get_random_number()
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    for index in range(len(random_number)):
        if user_input_number[index] is random_number[index]:
            result[0] += 1
        else:
...
def is_yes(one_more_input):
    ...
    if 'y' in one_more_input or 'Y' in one_more_input or 'Yes' in one_more_input \
        or 'YES' in one_more_input:
        result = True
    else:
        result = False
    # ==================================
...
def is_no(one_more_input):
    ...
    if one_more_input is 'n' or one_more_input is 'N' or one_more_input is 'NO' or one_more_input is 'no' \
        or one_more_input is 'No' or one_more_input is 'nO':
        result = True
    else:
        result = False
    # ==================================
