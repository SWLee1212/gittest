...
def delete_a_list_element(list_data, element_value):
    ...
    # result =['1','2','3','4'];
    # print("Func In :", list_data)
    # print("Func element :", element_value)
    # print("Func out :", result)
    # print("=================================")
...
def binary_converter(decimal_number):
    ...
    result = format(decimal_number,'02b')
    # ==================================
    return result
...
def number_of_cases(list_data):
    ...
    for loop_str_1 in list_data:
        for loop_str_2 in list_data:
            str_sum = str(loop_str_1)+str(loop_str_2)
            if(str_sum not in result):
                print(str_sum, type(loop_str_1) is str, type(loop_str_2) is str )
                result.append(str_sum)
...
#    pass
    ...
    # a = [1, 2, 3, 4, 5, 6]
    # b = [1, 2, 3]
    # print(comparison_list_size(a,b))
    # a= [1, 2, 3, 4, 5, 6]
    # b = [1, 2, 3, 5, 7, 8, 9, 10]
    # print(comparison_list_size(a,b))
...
#    print(discount_price(110000))
    # a = [5, 4, 3, -1, 100, 200]
    # print(find_smallest_value(a))

    # print(binary_converter(11))
    a = [1, 2, 3, 'a']
    number_of_cases(a)
